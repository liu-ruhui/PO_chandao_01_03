...
class MainPage(BasePage):
    ...
    # def get_usename(self,value):  #获取用户名
...
if __name__ =="__main__":
    ...
    main_page.open_url('http://127.0.0.1:8080/zentao/user-login-L3plbnRhby8=.html')
    time.sleep(5)
    driver.find_element(By.XPATH, '//input[@id="account"]').send_keys('admin')
    driver.find_element(By.XPATH, '//input[@name="password"]').send_keys('Lrh19960912')
    driver.find_element_by_id('submit').click()
    # main_page.get_attribute('text')
