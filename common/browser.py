...
dri_path = os.path.join(current_path,'..',conf.get_driver_path)

class Browser(object):
    def __init__(self,driver_path=dri_path,driver_name = conf.get_driver_name):
    ...
    def __get_chrome_driver(self):
        ...
        chrome_options.add_argument('--disable-gpu')  # 谷歌文档提到需要加上这个属性来规避bug(偶发性bug)
    ...
    def __get_remote_driver(self):  # selenium支持分布式 grid == > 配置（你自己的代码编写、对方机器配置）可以做远程
        pass
